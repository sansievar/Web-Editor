...
public class imageInputDialog extends javax.swing.JFrame implements ActionListener, webIntegrator {
...
"\t</head>\n" +
"\t<body>\n" +
"\t\t<div onChange=\"location.href=this[selectedIndex].value\">\n" +
"\t\t</div>\n" +
"\t</body>\n" +
"</html>";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Alternate Text");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(imageInputDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new imageInputDialog().setVisible(true);
            }
        });
    }
    ...
    public void addContent(String... content){
        ...
        try{
            ...
            sb.append("\"");
            sb.append(">\n");
            txtDoc.insert(sb.toString(), txtDoc.getText().indexOf("</div>")-1);
            txtSrc.setText("");
            txtAlt.setText("");
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Unable to add image - missing </div>");
        }
    }
