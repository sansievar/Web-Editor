...
public class orderedListInputDialog extends javax.swing.JFrame implements ActionListener, webIntegrator {
...
"\t</head>\n" +
"\t<body>\n" +
"\t\t<ol onChange=\"location.href=this[selectedIndex].value\">\n" +
"\t\t</ol>\n" +
"\t</body>\n" +
"</html>";
    
     /**
     * Creates new form orderedListInputDialog
     */
    public orderedListInputDialog() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Ordered List Generator");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(orderedListInputDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new orderedListInputDialog().setVisible(true);
            }
        });
    }
    ...
    public void addContent(String... content){
        ...
        try{
            ...
            txtDoc.insert(sb.toString(), txtDoc.getText().indexOf("</ol>")-1);
            txtDisplay.setText("");
            txtDisplay2.setText("");
            txtDisplay3.setText("");
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Unable to add item - missing </ol>");
        }
    }
