...
public class unOrderedListInputDialog extends javax.swing.JFrame implements ActionListener, webIntegrator {
...
"\t</head>\n" +
"\t<body>\n" +
"\t\t<ul onChange=\"location.href=this[selectedIndex].value\">\n" +
"\t\t</ul>\n" +
"\t</body>\n" +
"</html>";
    
     /**
     * Creates new form unOrderedListInputDialog
     */
    public unOrderedListInputDialog() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Unordered List Generator");

        jLabel1.setText("Item Text");

        jLabel2.setText("Item Text");

        jLabel3.setText("Item Text");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unOrderedListInputDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unOrderedListInputDialog().setVisible(true);
            }
        });
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(source == btnReset)
            ...
            String item1 = txtDisplay.getText();
            String item2 = txtDisplay2.getText();
            String item3 = txtDisplay3.getText();
            addContent(item1, item2, item3);
        }
    ...
    public void addContent(String... content){
        String item1 = content[0];
        String item2 = content[1];
        String item3 = content[2];
        ...
        try{
            ...
            if(txtDisplay3.getText().length() != 0){
                sb.append("\t\t\t<li>");
                sb.append(item3);
                sb.append("</li>\n");
            }
    
            txtDoc.insert(sb.toString(), txtDoc.getText().indexOf("</ul>")-1);
            txtDisplay.setText("");
            txtDisplay2.setText("");
            txtDisplay3.setText("");
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Unable to add item - missing </ul>");
        }
    }
